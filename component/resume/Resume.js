        ...
        <div className="row py-4">
          <div className="col-md-3 ">
            <div className="resume_navs_wrap">
              <h2>Why Hire Me ?</h2>
              <p>
                I am a React developer with 2 years of experience in the field.
                My expertise lies in creating responsive user interfaces and
                front-facing components using React/React.js. I am passionate
                about delivering efficient and engaging web applications.
              </p>
